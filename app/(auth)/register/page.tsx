    ...
    <main className="min-h-screen flex" style={{ background: "var(--bg)" }}>
      ...
      >
        ...
        <div>
          ...
          >
            Your journey<br />to a <em style={{ color: "#6EE7B7" }}>healthier<br />smile</em> starts<br />here.
          </h2>
        ...
        <p className="text-xs" style={{ color: "rgba(255,255,255,0.2)" }}>
          RA 10173 Compliant · Your data is safe with us
        </p>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-[400px] animate-fade-up">
          ...
          <p className="text-sm mb-8" style={{ color: "var(--ink-muted)" }}>
            Register to start booking appointments online
          </p>
